...
class TestGoalLengthInvariance:
    ...
    @pytest.mark.xfail(
        reason="written against the pre-postmortem scope.py extractor; the "
        "v3 re-anchored extractor does not preserve the unit-norm goal "
        "contract — research artifact, not on the v3 detection path",
        strict=False,
    )
